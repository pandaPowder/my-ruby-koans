...
class AboutRegularExpressions < EdgeCase::Koan
  ...
  def test_asterisk_means_zero_or_more
	...
	# it would only fail if it were surrounded by a larger pattern it was trying to match but that's not I think what they were getting at
    assert_equal nil, "azc"[/ab*c/]
	#I think it would probably never fail since it will always match ""
  end
  ...
  #
  # Why?
  # They will get as much data as they can
